...
import { shouldUseRealLLMs, getTestApiKey, getTestModel } from '../config/test.config';
...
describeIfRealLLM('Real LLM API Integration Tests', () => {
  describe('OpenAI Provider', () => {
    ...
    const skipIfNoKey = TEST_API_KEY && TEST_API_KEY !== 'test-openai-key' ? describe : describe.skip;
  ...
  describe('Gemini Provider', () => {
    ...
    const skipIfNoKey = TEST_API_KEY && TEST_API_KEY !== 'test-gemini-key' ? describe : describe.skip;
  ...
  describe('Grok Provider', () => {
    ...
    const skipIfNoKey = TEST_API_KEY && TEST_API_KEY !== 'test-grok-key' ? describe : describe.skip;
...
describe('Real LLM Test Configuration', () => {
  ...
  it('should report whether real LLMs are enabled', () => {
    ...
    console.log('With optional API keys: TEST_OPENAI_API_KEY, TEST_GEMINI_API_KEY, TEST_GROK_API_KEY');
