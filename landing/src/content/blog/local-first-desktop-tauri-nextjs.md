...
Placeholder — technical post aimed at dev.to and Show HN. Planned for
Tue 18 Aug per the launch plan; covers the Tauri + Next.js architecture,
the client-only LLM constraint, why the database stays local, and what
was hard.
