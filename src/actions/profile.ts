...
export async function createProfile(
  ...
  const profile = await prisma.profile.create({
    data: {
      ...
      workAuthorization: resumeJson?.header?.workAuthorization ?? null,
      nationality: resumeJson?.header?.nationality ?? null,
      dateOfBirth: resumeJson?.header?.dateOfBirth ?? null,
