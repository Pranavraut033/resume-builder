...
2. Is the user asking a question (starts with or contains "what", "should I", "am I", "how do I", "will they", "is this", "can I") rather than instructing a change? → question. This wins even if a section name is mentioned, e.g. "what more can I add to my experience section" is question, not edit — the user hasn't said to change anything yet.
...
9. Does the message ask specifically about ATS or applicant tracking systems? → ats
10. None of the above clearly apply → other
...
Respond with ONLY the intent label as a single word from "edit", "interview", "tailor", "regenerate", "question", "ats", "cover_letter", "humanize", "undo", or "other".
