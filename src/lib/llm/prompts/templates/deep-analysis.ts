...
Return ONLY valid JSON matching the DocumentAnalysisSchema. Example shape:
{
  ...
  "findings": [
    ...
    { "path": "/experience/0/achievements/0", "original": "CPA", "suggestion": "Certified Public Accountant (CPA)", "kind": "keyword", "severity": "warning", "why": "JD requires the full form; resume only has the acronym embedded in this bullet.", "source": "llm" },
