...
| `FloatingActionBar.tsx`        | Inline actions (PDF, Undo/Redo, Customize, Template, ATS, Humanize, Chat) + a `⋯` overflow (Sections, History, Proofread, Gap analysis, Download JSON). Exports `DrawerName` — the source of truth for openable drawers.         |
...
| `CustomizationDrawer.tsx`      | Colors/fonts/layout for this job's `Customization`.                                                                                                                                                                              |
| `TemplatePicker.tsx`           | Template switching.                                                                                                                                                                                                              |
